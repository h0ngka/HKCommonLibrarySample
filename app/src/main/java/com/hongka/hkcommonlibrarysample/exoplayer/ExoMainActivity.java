...
import com.hongka.hkcommonlibrarysample.databinding.ActivityExoMainBinding;
...
/**
 * Created by jusung.kim@sk.com on 2017/05/29
 */

public class ExoMainActivity extends AppCompatActivity {
    private static final String TAG = ExoMainActivity.class.getSimpleName();
    private ActivityExoMainBinding mBinding;
    private String mTitle;

    public static Intent makeIntent(Context context, String title) {
        Intent intent = new Intent(context, ExoMainActivity.class);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.activity_exo_main);
        ...
        if (dataUri != null) {
            ...
            try {
                ...
                Toast.makeText(getApplicationContext(), R.string.list_load_error, Toast.LENGTH_LONG)
                        .show();
            }
        ...
        ExoListLoader loaderTask = new ExoListLoader();
    ...
    private void onSampleGroups(final List<SampleGroup> groups, boolean sawError) {
        ...
        mBinding.sampleList.setAdapter(new SampleAdapter(this, groups));
        mBinding.sampleList.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            @Override
    ...
    private final class ExoListLoader extends AsyncTask<String, Void, List<SampleGroup>> {
